package com.packt.linkedin.example.sociallinkd.customer.impl;
 ...
 * @author Craig Walls
 */
public class MyLinkedInTemplate extends AbstractOAuth2ApiBinding implements LinkedIn {
	 ...
	 */
	public MyLinkedInTemplate(String accessToken) {
		super(accessToken);
	...
	private void registerOAuth2Interceptor(String accessToken) {
		...
		interceptors.add(new MyLinkedInTemplate.OAuth2TokenParameterRequestInterceptor(accessToken));
	...
	private static boolean interceptorsSupported = ClassUtils.isPresent("org.springframework.http.client.ClientHttpRequestInterceptor", org.springframework.social.linkedin.api.impl.LinkedInTemplate.class.getClassLoader());

	public static final String BASE_URL = "https://api.linkedin.com/v2/people/";
